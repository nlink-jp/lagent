...
- The system prompt is gem-agent's, unchanged, until Phase 1 measurements
  justify a local-model rewrite (RFP §3). Prompts tuned for cloud models are
  not assumed to work here — measure first.
